...
export default function Header({ rightElement }) {
    ...
    return (
        <div className="pt-[max(env(safe-area-inset-top),0px)] shrink-0 bg-[#0A0F1E]/60 backdrop-blur-2xl sticky top-0 z-50 shadow-[0_4px_30px_rgba(0,0,0,0.1)] border-b border-white/5 flex flex-col w-full" style={{ borderBottom: '1px solid rgba(245,158,11,0.15)' }}>
